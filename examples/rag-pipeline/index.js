...
const KNOWLEDGE_BASE = [
    ...
    {
        id: 2,
        text: 'LLMFlow captures traces via an OpenAI-compatible proxy on port 8080.',
        topic: 'proxy',
    },
    {
        id: 3,
    ...
    {
        id: 5,
        text: 'The LLMFlow SDK enables hierarchical span tracking for complex pipelines.',
        topic: 'sdk',
    },
    {
        id: 6,
    ...
    {
        id: 7,
        text: 'LLMFlow calculates token usage and estimated costs automatically.',
        topic: 'costs',
    },
    {
        id: 8,
